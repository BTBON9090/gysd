...
<template>
  <div class="biz-page cases-page">
    <header class="biz-head cases-head"><div class="cases-heading"><span class="cases-heading-icon"><BookOpen :size="24" /></span><div><h1>案例管理 <span class="cases-count">{{ c.data.cases.length }}</span></h1><p>用真实交付案例说明服务能力，发布服务时可直接引用。</p></div></div><ElButton type="primary" @click="open()"><Plus :size="15" /> 创建案例</ElButton></header>
